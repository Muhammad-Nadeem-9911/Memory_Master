...
public class Main3Activity extends AppCompatActivity {
    ...
    private void calculate(){
        ...
        if (firstcard == secondcard){
            ...
            iv_41.setImageResource(R.drawable.front);
            iv_42.setImageResource(R.drawable.front);
            iv_43.setImageResource(R.drawable.front);
            iv_44.setImageResource(R.drawable.front);
            iv_51.setImageResource(R.drawable.front);
            iv_52.setImageResource(R.drawable.front);
            iv_53.setImageResource(R.drawable.front);
            iv_54.setImageResource(R.drawable.front);
